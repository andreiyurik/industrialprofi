...
**Амплитуда (U_m)** — максимальное отклонение от нуля. В бытовой сети России U_m = **311 В**. Это пиковое напряжение — именно его выдерживают [диэлектрические перчатки](/lessons/01-siz-elektrika) и изоляция кабелей.
