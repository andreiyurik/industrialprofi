...
4. **Формат матрицы** — через кроп-фактор, как разобрано в статье [фокусное — это точка зрения](/ru/lessons/02-fv-fokusnoe-eto-tochka-zreniya).
...
>
> Но это ориентир, а не закон. Точное значение для **твоего** объектива ты получишь измерением в [тесте объектива](/ru/lessons/08-fv-test-obektiva). Знание собственного оптимума — то, что отличает человека, знающего свою оптику, от человека, читавшего про неё.
