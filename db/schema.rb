...
ActiveRecord::Schema[8.1].define(version: 2026_08_03_012009) do
  ...
  create_virtual_table "lesson_search_index", "fts5", ["title", "description", "body", "lesson_id UNINDEXED", "tokenize = 'unicode61 remove_diacritics 2'"]
end
