...
gem "sqlite3", ">= 2.1"
# json 3.0 dropped JSON.parse's positional options hash, which ActiveSupport
# 8.1.3 still passes (active_support/json/decoding.rb) — every JSON column and
# every signed cookie raises ArgumentError. Unpin once Rails ships a fix.
gem "json", "< 4"
